...
PROGRAM RUNEXAMPLE1
  ...
  call initialize
  call cpu_time(time1)
  call wrap_dvode(neq,T,TOUT,Y,Fdvode)
  call cpu_time(time2)
  ...
  call initialize
  call cpu_time(time1)
  call wrap_dvodef90OMP(neq,T,TOUT,Y,Fgeneral)
  call cpu_time(time2)
  ...
  call initialize
  call cpu_time(time1)
  call wrap_odepack(neq,T,TOUT,Y,Fodepack)
  call cpu_time(time2)
  ...
  call initialize
  call cpu_time(time1)
  call wrap_radau5(neq,T,TOUT,Y,Fgeneral)
  call cpu_time(time2)
  ...
  call initialize
  call cpu_time(time1)
  call wrap_radau(neq,T,TOUT,Y,Fgeneral)
  call cpu_time(time2)
  ...
  call initialize
  call cpu_time(time1)
  call wrap_rodas(neq,T,TOUT,Y,Fgeneral)
  call cpu_time(time2)
  ...
  call initialize
  call cpu_time(time1)
  call wrap_sdirk4(neq,T,TOUT,Y,Fgeneral)
  call cpu_time(time2)
