...
C --- MOD FOR THREAD SAFETY
      INTEGER NN,NN2,NN3,NN4
      REAL*8 XOLD,HSOL,CONT(LRCONT-2)
      INTEGER NFCN,NJAC,NSTEP,NACCPT,NREJCT,NDEC,NSOL
C *** *** *** *** *** *** ***
C  INITIALISATIONS
C *** *** *** *** *** *** ***
...
C --- FAIL EXIT
 ...
 979  FORMAT(' EXIT OF SDIRK4 AT X=',D14.7,'   H=',D14.7,'   IER=',I4)
      ...
      END
C
      REAL*8 FUNCTION CONTS4(I,X,NN,NN2,NN3,NN4,XOLD,HSOL,CONT) 
C ----------------------------------------------------------
