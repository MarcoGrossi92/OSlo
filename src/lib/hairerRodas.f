...
C      
C     VERSION OF MARCH 21, 2024 (Modification at line 381)
C
C     INPUT PARAMETERS  
C     ----------------  
...
C -------- UROUND   SMALLEST NUMBER SATISFYING 1.D0+UROUND>1.D0  
      ...
      ELSE
         UROUND=WORK(1)
         ! Edit 21 march 2024 - Marco Grossi
         ! Threshold has been modified wrt to the original file. From 1d-16 to 1d-19
         IF(UROUND.LT.1.D-19.OR.UROUND.GE.1.D0)THEN
...
C *** *** *** *** *** *** ***
     ...
     &            M1,M2,NM1,FAC,E,LDE,IP,IER,IJOB,IMPLCT,IPHES,
