...
! universal solver
         CALL dodesol(ipar,n,t,t_end,y,rhs_v_d_p,jacmat_v_d_p,h,hm,ep,tr,dpar,kd,ierr)
         ...
         IF(dabs(y(1)-1.878d0)+dabs(y(2)+0.7436d0).gt.1.d-2) THEN
            PRINT*,'Solution seems to be inaccurate. Probably, example FAILED...'
            STOP 1
      	 END IF
...
! value y at t=0
         ...
         CALL CPU_TIME(time_begin)
! explicit solver
         CALL dodesol_rkm9st(ipar,n,t,t_end,y,rhs_v_d_p,h,hm,ep,tr,dpar,ierr)
...
! implicit solver with automatic numerical Jacobi matrix computations
         CALL dodesol_mk52lfn(ipar,n,t,t_end,y,rhs_v_d_p,h,hm,ep,tr,dpar,kd,ierr)
...
! implicit solver with user-defined Jacobi matrix computations
         CALL dodesol_mk52lfa(ipar,n,t,t_end,y,rhs_v_d_p,jacmat_v_d_p,h,hm,ep,tr,dpar,kd,ierr)
...
! hybrid solver with automatic numerical Jacobi matrix computations
         CALL dodesol_rkm9mkn(ipar,n,t,t_end,y,rhs_v_d_p,h,hm,ep,tr,dpar,kd,ierr)
...
! hybrid solver with user-defined Jacobi matrix computations
         CALL dodesol_rkm9mka(ipar,n,t,t_end,y,rhs_v_d_p,jacmat_v_d_p,h,hm,ep,tr,dpar,kd,ierr)
         ...
         PRINT*
      	 ...
      	 END IF        
      	 PRINT*, '========================'
         PRINT*, 'DODESOL FORTRAN example successfully PASSED through all steps of computations'
         PRINT*
          
      STOP 0
      END

!********************** Example for Van der Pol equations **************  
